...
export default function App() {
  const WHATSAPP_LINK =
    "https://wa.me/5581992351361?text=Olá%20Dra.%20Anne,%20gostaria%20de%20agendar%20uma%20consulta.";
    ...
    <div className="min-h-screen selection:bg-brand-secondary selection:text-brand-cream">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex flex-col">
            <span className="font-serif text-lg font-bold tracking-tight text-brand-primary">
              Anne K. Santos Barbosa
            </span>
            <span className="text-[10px] uppercase tracking-[0.2em] text-brand-secondary font-medium">
              Psicóloga Clínica • CRP 03/30790
            </span>
          </div>
          <motion.a
            href={WHATSAPP_LINK}
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <h1 className="font-serif text-[2.8rem] md:text-7xl lg:text-8xl leading-[1.1] mb-6 text-brand-primary font-bold">
                Acolhimento e{" "}
                <span className="italic font-normal">neurociência</span>.
              </h1>
              <p className="text-lg md:text-xl text-brand-text mb-8 font-light leading-relaxed max-w-md md:max-w-none">
                Reconquiste seu equilíbrio através de uma prática clínica
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-start gap-4 px-2 w-full pb-10 md:pb-0">
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="w-8 h-8 rounded-full border-2 border-brand-cream bg-brand-accent flex items-center justify-center"
                      >
                        <CheckCircle2 className="w-4 h-4 text-brand-primary" />
                      </div>
                    ))}
                  </div>
                  <span className="text-xs md:text-sm font-medium text-brand-secondary tracking-tight text-center sm:text-left">
                    + de 5 anos de experiência clínica
                  </span>
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-primary/70 leading-relaxed">
                      Bacharel em Psicologia pela UFAL (2020), desenvolvendo um
                      olhar humanizado e crítico desde a graduação.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-primary/70 leading-relaxed">
                      Conhecimento avançado sobre as funções cerebrais e sua
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-primary/70 leading-relaxed">
                      Pós-graduação pela UFS, com vasta experiência em contextos
                      de saúde pública, hospitalar e atenção primária (APS).
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              ...
              <span className="italic">suporte clínico</span>?
            </motion.h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="font-serif text-2xl font-bold mb-4 text-brand-primary">
                Prática Baseada em Evidências
              </h3>
              <p className="text-brand-text leading-relaxed opacity-80">
                Abordagem técnica que une o conhecimento científico atualizado à
            ...
            >
              ...
              <p className="text-brand-text leading-relaxed opacity-80">
                Um olhar que entende o funcionamento cerebral por trás das
                emoções, proporcionando clareza sobre processos mentais.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-brand-text leading-relaxed opacity-80">
                Experiência prática em casos de alta complexidade emocional e
                clínica no SUS e ambiente hospitalar.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeIn}>
              <h2 className="font-serif text-4xl md:text-6xl mb-8 leading-tight">
                Se os dias parecem{" "}
                <span className="italic font-light">pesados demais</span>, você
                não precisa carregar tudo só.
              </h2>
              <p className="text-xl text-brand-accent mb-12 font-light">
                O atendimento é direcionado a quem busca retomar as rédeas da
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 bg-brand-white/5 p-4 rounded-xl border border-brand-white/10"
                  >
            ...
            >
              ...
              <h3 className="font-serif text-3xl font-bold mb-6 text-brand-primary">
              ...
              <ul className="space-y-6">
                <li className="flex gap-4">
                  ...
                  <p className="leading-relaxed">
                    <strong>Jovens Adultos:</strong> Navegando pelas crises de
                    identidade, carreira e relacionamentos modernos.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1.5 w-2 h-2 shrink-0 bg-brand-secondary rounded-full"></div>
                  <p className="leading-relaxed">
                    <strong>Adultos:</strong> Lidar com a exaustão da rotina,
                    ansiedade e o equilíbrio entre vida e profissionalismo.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="mt-1.5 w-2 h-2 shrink-0 bg-brand-secondary rounded-full"></div>
                  <p className="leading-relaxed">
                    <strong>Idosos:</strong> Resgate da autonomia, processamento
                    do luto e adaptações sociais.
                  </p>
                </li>
              </ul>
            </motion.div>
      ...
      <section className="py-24 bg-brand-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-brand-secondary font-bold uppercase tracking-[0.2em] text-xs">
              Simples e Seguro
            </span>
            <h2 className="font-serif text-4xl text-brand-primary mt-4">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              ...
              <p className="text-brand-primary/60">
                No conforto e privacidade da sua casa, conectando-se de onde
                você estiver.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-brand-primary/60">
                Tempo de qualidade dedicado à sua história, respeitando seu
                tempo interno em cada sessão.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-brand-primary/60">
                Sem burocracia. Entre em contato via WhatsApp e escolha o melhor
                horário.
              </p>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div {...fadeIn}>
            <h2 className="font-serif text-5xl md:text-7xl text-brand-primary mb-8 leading-[1.1]">
              Vamos dar o próximo{" "}
              <span className="italic font-light">passo</span>?
            </h2>
      ...
      <footer className="py-20 bg-brand-white border-t border-brand-cream">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12">
          <div>
            <span className="font-serif text-2xl font-bold tracking-tight text-brand-primary block mb-4">
              Anne K. Santos Barbosa
            </span>
            <p className="text-sm text-brand-secondary italic">
              Transformando sofrimento em resiliência através da clínica e
              ciência.
            </p>
          </div>

          <div className="flex flex-col gap-4">
            <span className="text-xs uppercase tracking-[0.2em] font-bold text-brand-secondary">
              Contato
            </span>
            <a
              href="tel:+5581992351361"
          ...
          <div className="flex flex-col gap-4">
            ...
            <span className="text-brand-primary text-sm opacity-60">
